    ...
    var name by rememberSaveable {
     ...
     Surface(
        ...
        //        AutoCompleteList(airports = routeSchedule)
            ...
            //SelectedDestinationList(name = "OPO", iata = "Fransico", viewModel = viewModel, selectedAirports = selected)
    ...
    Column(
        ...
        LazyColumn {
            items(selectedAirports) { airport ->
               SelectedListCard(airport = airport, viewModel =viewModel, name = name, iata = iata)
            }
        }
    }
}
    ...
    Card (
        ...
        Row(
            ...
            IconButton(onClick = {addedButton=!addedButton
                ...
                LaunchedEffect (key1 = addedButton){
                    viewModel.addFav(UiState())
                }
                if(addedButton)
                Icon(
